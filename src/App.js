    ...
    return (
      <Router>
        <div className="App">
          ...
          <Route path="/directory/:fentities" exact render={({ match }) => <Fentities key={Math.random}  match={match} state={state} />} />
          <Route path="/directory/:fentities/:name" exact render={({ match }) => <Fentity key={Math.random}  match={match} state={state} />} />
